...
public class ChargeReadPlatformServiceImpl implements ChargeReadPlatformService {
    ...
    public ChargeData retrieveNewChargeDetails() {
        ...
        final Map<String, List<GLAccountData>> expenseAccountOptions = this.accountingDropdownReadPlatformService
                .retrieveExpenseAccountOptions();
        final Map<String, List<GLAccountData>> assetAccountOptions = this.accountingDropdownReadPlatformService
