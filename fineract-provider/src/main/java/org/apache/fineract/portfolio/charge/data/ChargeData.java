...
public final class ChargeData implements Comparable<ChargeData>, Serializable {
    ...
    private final Map<String, List<GLAccountData>> expenseAccountOptions;
    private final Map<String, List<GLAccountData>> assetAccountOptions;
    ...
    public static ChargeData template(final Collection<CurrencyData> currencyOptions,
            ...
            Map<String, List<GLAccountData>> expenseAccountOptions, Map<String, List<GLAccountData>> assetAccountOptions) {
    ...
    private ChargeData(final Long id, final String name, final BigDecimal amount, final CurrencyData currency,
            ...
            String accountMappingForChargeConfig, Map<String, List<GLAccountData>> expenseAccountOptions,
            Map<String, List<GLAccountData>> assetAccountOptions) {
        this.id = id;
        this.name = name;
        this.amount = amount;
